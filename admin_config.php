...
if (!$pref['plug_installed']['prototype']) {
    print "<br /><br /><br />Fr Barry Prototype plugin MUST BE INSTALLED<br /><br /><br />";
}
require_once(e_HANDLER . "userclass_class.php");
...
if (e_QUERY == "update") {
    ...
    if ($ECLASSF_PREF['eclassf_useseo'] != $_POST['eclassf_useseo']) {
        ...
        switch ($result) {
            case 1:
                ...
                $eclassf_msgtext .= '<li>' . ECLASSF_A158 . '</li>' ;
                break;
            case 2:
                $eclassf_msgtext .= '<li>' . ECLASSF_A159 . '</li>' ;
                break;
            case 3:
                $eclassf_msgtext .= '<li>' . ECLASSF_A160 . '</li>' ;
                break;
            case 4:
                $eclassf_msgtext .= '<li>' . ECLASSF_A161 . '</li>';
                break;
            case 5:
                $eclassf_msgtext .= '<li>' . ECLASSF_A161 . '</li>';
                break;
            default:
                ...
                $eclassf_msgtext .= '<li>' . ECLASSF_A162 . '</li>' ;
        } // switch
    }
	#$ECLASSF_PREF['eclassf_counter'] = 'ng'; // force non graphical
    $ECLASSF_PREF['eclassf_useseo'] = (int)$_POST['eclassf_useseo'];
    $ECLASSF_PREF['eclassf_email'] = (int)$_POST['eclassf_email'];
    $ECLASSF_PREF['eclassf_approval'] = (int)$_POST['eclassf_approval'];
    $ECLASSF_PREF['eclassf_valid'] = (int)$_POST['eclassf_valid'];
    $ECLASSF_PREF['eclassf_read'] = (int)$_POST['eclassf_read'];
    $ECLASSF_PREF['eclassf_create'] = (int)$_POST['eclassf_create'];
    $ECLASSF_PREF['eclassf_admin'] = (int)$_POST['eclassf_admin'];
    $ECLASSF_PREF['eclassf_useremail'] = (int)$_POST['eclassf_useremail'];
    $ECLASSF_PREF['eclassf_terms'] = $tp->toDB($_POST['eclassf_terms']);
    $ECLASSF_PREF['eclassf_perpage'] = (int)$_POST['eclassf_perpage'];
    $ECLASSF_PREF['eclassf_pich'] = (int)$_POST['eclassf_pich'];
    $ECLASSF_PREF['eclassf_picw'] = (int)$_POST['eclassf_picw'];
    ...
    $ECLASSF_PREF['eclassf_leadz'] = (int)$_POST['eclassf_leadz'];
    $ECLASSF_PREF['eclassf_thumbs'] = $tp->toDB($_POST['eclassf_thumbs']);
    $ECLASSF_PREF['eclassf_icons'] = (int)$_POST['eclassf_icons'];
    $ECLASSF_PREF['eclassf_counter'] = $tp->toDB($_POST['eclassf_counter']);
    $ECLASSF_PREF['eclassf_thumbheight'] = (int)$_POST['eclassf_thumbheight'];
    $ECLASSF_PREF['eclassf_subdrop'] = (int)$_POST['eclassf_subdrop'];
    $ECLASSF_PREF['eclassf_dformat'] = $tp->toDB($_POST['eclassf_dformat']);
    $ECLASSF_PREF['eclassf_userating'] = (int)$_POST['eclassf_userating'];
    $ECLASSF_PREF['eclassf_maxpic'] = (int)$_POST['eclassf_maxpic'];
    $ECLASSF_PREF['eclassf_allowedpic'] = (int)$_POST['eclassf_allowedpic'];
    $ECLASSF_PREF['eclassf_watermark'] = $tp->toDB($_POST['eclassf_watermark']);
    $ECLASSF_PREF['eclassf_notifymethod'] = (int)$_POST['eclassf_notifymethod'];
...
$eclassf_text .= "
		<tr>
			...
			<td class='forumheader3'>
				...
				".$prototype_obj->help_area('baz1','this is help',false)."
			</td>
		</tr>";
$eclassf_text .= "
		<tr>
...
$eclassf_text .= "
		<tr>
			<td style='width:30%' class='forumheader3'>" . ECLASSF_A163 . "</td>
			<td style='width:70%' class='forumheader3'>
				<input type='radio' value='0' class='tbox' style='border:0px;' id='eclassf_notifymethod_email' name='eclassf_notifymethod' " . ($ECLASSF_PREF['eclassf_notifymethod'] == "0"?"checked='checked'":'') . " /><label for='eclassf_notifymethod_email'> " . ECLASSF_A164 . "</label><br />
				<input type='radio' value='1' class='tbox' style='border:0px;' id='eclassf_notifymethod_pm' name='eclassf_notifymethod' " . ($ECLASSF_PREF['eclassf_notifymethod'] == "1"?"checked='checked'":'') . " /><label for='eclassf_notifymethod_pm'> " . ECLASSF_A165 . "</label><br />
				<input type='radio' value='2' class='tbox' style='border:0px;' id='eclassf_notifymethod_emailpm' name='eclassf_notifymethod' " . ($ECLASSF_PREF['eclassf_notifymethod'] == "2"?"checked='checked'":'') . " /><label for='eclassf_notifymethod_emailpm'> " . ECLASSF_A166 . "</label>
			</td>
		</tr>";
		...
		<tr>
			...
			<td class='forumheader3'>
				<select class='tbox' name='eclassf_counter'>
					...
					<option value='ng' " . ($ECLASSF_PREF['eclassf_counter'] == 'ng'?"selected='selected'":"") . ">Non Graphical</option>
...
$ns->tablerender(ECLASSF_A12, $eclassf_text, 'eclassf_conf');
