 CREATE TABLE eclassf_ads (
  ...
  eclassf_prefix char(32) default NULL,
  PRIMARY KEY  (eclassf_id),
  KEY eclassf_name (eclassf_name),
  KEY eclassf_desc (eclassf_desc),
  KEY eclassf_category (eclassf_category),
 ...
 CREATE TABLE eclassf_subcats (
  ...
  CREATE TABLE eclassf_unique (
   eclassf_unique_adid int(11) DEFAULT '0',
   eclassf_unique_ip char(15) DEFAULT NULL,
   UNIQUE KEY unique_views (eclassf_unique_adid,eclassf_unique_ip)
 ) TYPE=MyISAM DEFAULT CHARSET=utf8;