...
global $eclassf_pmto,$pref,$ECLASSF_PREF;
if($pref['plug_installed']['pm'] &&  $ECLASSF_PREF['eclassf_notifymethod']>0){
if ($eclassf_pmto > 0)
{
...
global $eclassf_itemid,$ECLASSF_PREF;
if (check_class($ECLASSF_PREF['eclassf_create']) || check_class($ECLASSF_PREF['eclassf_admin']) )
{
	$retval="<a href='".e_PLUGIN."e_classifieds/manage_adds.php?action=godo&amp;catid=$eclassf_itemid&amp;actvar=edit'><img src='".e_IMAGE."admin_images/edit_16.png' style='border:0;' alt='".ECLASSF_36."' title='".ECLASSF_36."'/></a>";
}
...
global $eclassf_obj,$eclassf_from,$eclassf_catid,$eclassf_subid;
   $eclassf_url=$eclassf_obj->make_url($eclassf_from,'list',$eclassf_catid,$eclassf_subid,0);
return "<a href='" . $eclassf_url . "'><img src='./images/updir.png' title='".ECLASSF_124."' alt='".ECLASSF_124."' style='border:0;'/></a>";
SC_END
...
global $eclassf_obj,$tp,$eclassf_from,$eclassf_categoryid,$eclassf_subid,$eclassf_subname;
$eclassf_url=$eclassf_obj->make_url($eclassf_from,'list',$eclassf_categoryid,$eclassf_subid,0);
$retval ="<a href='" . $eclassf_url . "'>" . $tp->toHTML($eclassf_subname) . "</a>";
return $retval;
SC_END
...
global $eclassf_obj,$tp,$eclassf_from,$eclassf_catid,$eclassf_subid;
  $eclassf_url= $eclassf_obj->make_url($eclassf_from,'cat',$eclassf_catid,$eclassf_subid,0);
return "<a href='" . $eclassf_url . "'><img src='./images/updir.png' alt='" . ECLASSF_121 . "' title='" . ECLASSF_121 . "' style='border:0;'/></a>";
SC_END
...
global $eclassf_obj,$eclassf_from,$eclassf_catid,$eclassf_catname,$tp;
   $eclassf_url=$eclassf_obj->make_url($eclassf_from,'sub',$eclassf_catid,0,0);
$retval ="<a href='" . $eclassf_url . "'>" . $tp->toHTML($eclassf_catname) . "</a>";
return $retval;
SC_END
...
global $eclassf_obj,$tp, $eclassf_from, $eclassf_catid, $eclassf_subid, $eclassf_id, $eclassf_name;
$eclassf_url=$eclassf_obj->make_url($eclassf_from,'item',$eclassf_catid,$eclassf_subid,$eclassf_id);
$retval = "<a href='" . $eclassf_url . "'>" . $tp->toHTML($eclassf_name) . "</a>";
return $retval;
SC_END
...
else
{
   ...
   $eclassf_url=$eclassf_obj->make_url($eclassf_from,'item',$eclassf_catid,$eclassf_subid,$eclassf_id);
$retval .= "<a href='" . $eclassf_url . "'><img src='{$img_name}' style='border:0;width:".$ECLASSF_PREF['eclassf_thumbheight']."px;height:".$ECLASSF_PREF['eclassf_thumbheight']."px;' alt='" . ECLASSF_114 . "' title='" . ECLASSF_114 . "'/></a>";
...
global $eclassf_obj,$ECLASSF_PREF, $tp, $eclassf_from, $eclassf_tmp, $eclassf_catid, $eclassf_subid, $eclassf_itemid;
$eclassf_url=$eclassf_obj->make_url($eclassf_from,'sub',$eclassf_catid,$eclassf_subid,0);
return "
	<a href='" . $eclassf_url . "'><img src='./images/updir.png' alt='" . ECLASSF_121 . "' title='" . ECLASSF_121 . "' style='border:0;'/></a>";
SC_END
...
global $eclassf_obj,$ECLASSF_PREF, $tp, $eclassf_from, $eclassf_tmp, $eclassf_catid, $eclassf_subid, $eclassf_itemid;
$eclassf_url=$eclassf_obj->make_url($eclassf_from,'cat',$eclassf_catid,$eclassf_subid,$eclassf_itemid);
return "
	<a href='" . $eclassf_url . "'><img src='./images/updir.png' alt='" . ECLASSF_121 . "' title='" . ECLASSF_121 . "' style='border:0;'/></a>";
SC_END
